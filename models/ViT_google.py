...
class ViT_google(nn.Module):
    def __init__(self, image_size, num_classes, path="imagenet21k+imagenet2012_ViT-B_16.pth"):
        super().__init__()
        self.backbone = VisionTransformer((image_size,image_size))
        self.backbone.load_state_dict(torch.load(path)['state_dict'])
...
class ViTResNeXt_google(nn.Module):
    def __init__(self, image_size, num_classes, path="imagenet21k+imagenet2012_ViT-B_16.pth"):
        super().__init__()
        ViT = VisionTransformer((image_size,image_size))
